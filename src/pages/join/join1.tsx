...
function App() {
    ...
    const allCheckf = useCallback((e: ChangeEvent<HTMLInputElement>) => {
    ...
    const checkF = useCallback((e: ChangeEvent<HTMLInputElement>) => {
        const { name, checked } = e.target;
        if(name === "check1"){
            setCheck1(checked)
        }
            ...
            <div className="row">
                ...
                <div className="col-12" style={{ height: '700px' }}>
                    <div className="card h-100 w-100">
                        <div className="card-header">회원가입 (1/3) 이용약관 동의</div>
                        <div className="card-body">
                            <h5 className="card-title">
                                <p className="fs-5 text-dark fw-bold">전체동의</p>
                            </h5>
                            ...
                            <p className="card-text">
                                <p className="fs-6 text-dark fw-bold">[필수] 이용약관 동의</p>
                                ...
                                <p className="fs-6 text-dark fw-bold">[필수] 개인정보 수집 및 이용 동의</p>
                                <textarea className="form-control" rows={5}>
                                    1. 개인정보 수집목적 및 이용목적
